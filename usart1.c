...
void Usart1_Init(void)
{
    ...
    *RCC_APB2ENR |= 1 << 4;
    ...
    volatile uint32_t* USART1_BRR = (uint32_t*)(USART1_BASE_ADDR + 0x08);
    volatile uint32_t* USART1_SR = (uint32_t*)(USART1_BASE_ADDR + 0x00);
    volatile uint32_t* USART1_CR1 = (uint32_t*)(USART1_BASE_ADDR + 0x0C);
    volatile uint32_t* USART1_CR2 = (uint32_t*)(USART1_BASE_ADDR + 0x10);
...
{
    volatile uint32_t* USART1_SR = (volatile uint32_t*)(USART1_BASE_ADDR + 0x00);
    volatile uint32_t* USART1_DR = (volatile uint32_t*)(USART1_BASE_ADDR + 0x04);
